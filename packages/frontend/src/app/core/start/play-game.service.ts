...
export class PlayGameService {
  ...
  /**
   * Update elapsed turns.
   */
  public async updateElapsedTurns() {
    const elapsedTurns: any = await this._contractApiService.getElapsedTurns();
    this._eventAggregatorService.dispatch({
      type: GameActionTypeEnum.SetElapsedTurns,
      payload: {
        elapsedTurns
      }
    });
